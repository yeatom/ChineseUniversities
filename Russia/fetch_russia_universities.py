...
def fetch_russia_universities():
    url = "https://yxcx.cscse.edu.cn/api/xlxwrzz/xlxwrz/getUniversityListOrPage"
    payload = {
        "country": "俄罗斯",
        "currentPage": 1,
        "pageSize": 2000,  # Russia likely has many universities
        "universityIndex": ""
    }
    ...
    try:
        ...
        json_path = os.path.join(os.path.dirname(__file__), "russia_universities_raw.json")
