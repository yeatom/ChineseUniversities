...
def fetch_japan_raw():
    ...
    try:
        ...
        mapping_path = os.path.join(os.path.dirname(__file__), "japan_universities_raw.json")
...
def main():
    mapping_path = os.path.join(os.path.dirname(__file__), "japan_universities_raw.json")
    csv_path = os.path.join(os.path.dirname(__file__), "japan_universities.csv")
    ...
    for i in range(0, len(to_translate), batch_size):
        ...
        translated_batch = translator.translate_university_names(batch, country="Japan", language="Japanese")
